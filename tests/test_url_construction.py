...
class TestURLConstruction:
    ...
    async def test_file_path_properly_encoded_in_url(self):
        ...
        with aioresponses() as m:
            ...
            m.get(
                "http://ha.local:8123/api/management/files/my%20config.yaml",
                status=200,
                body="homeassistant:\n  name: Home",
            )
    ...
    async def test_file_path_with_subdirectory_encoded(self):
        ...
        with aioresponses() as m:
            ...
            m.get(
                "http://ha.local:8123/api/management/files/packages/lights.yaml",
                status=200,
                body="light:\n  - platform: hue",
            )
    ...
    async def test_file_path_with_special_characters_encoded(self):
        ...
        with aioresponses() as m:
            ...
            m.get(
                "http://ha.local:8123/api/management/files/test%26file%3Dconfig.yaml",
                status=200,
                body="test: data",
            )
    ...
    async def test_url_construction_preserves_port(self):
        ...
        with aioresponses() as m:
            ...
            m.get("http://ha.local:8123/api/states", status=200, body="[]")
    ...
    async def test_url_construction_with_ip_address(self):
        ...
        with aioresponses() as m:
            ...
            m.get("http://192.168.1.100:8123/api/events", status=200, body="[]")
