...
Line 4"""
        try:
            ...
            assert error_dict["line"] in [
                3,
                4,
            ]  # Could be line 3 or 4 depending on Jinja2 version
            assert "context" in error_dict
    ...
    def test_format_error_single_line_no_excerpt(self):
        ...
        try:
            ...
            assert (
                "template_excerpt" not in error_dict
                or error_dict["template_excerpt"] is None
            )
...
class TestTemplateError:
    ...
    def test_to_dict_minimal(self):
        ...
        error = TemplateError(error_type="TemplateSyntaxError", message="Test error")
