...
class TestDownloadWorkflow:
    ...
    @pytest.mark.asyncio
    async def test_complete_download_workflow(self, mock_mcp_server, temp_workspace, mock_ha_api):
        """
    ...
    @pytest.mark.asyncio
    async def test_workflow_step_order(self, mock_mcp_server, temp_workspace, mock_ha_api):
        """
    ...
    @pytest.mark.asyncio
    async def test_file_saved_to_correct_location(self, mock_mcp_server, temp_workspace, mock_ha_api):
        """
    ...
    @pytest.mark.asyncio
    async def test_metadata_recorded_correctly(self, mock_mcp_server, temp_workspace, mock_ha_api):
        """
    ...
    @pytest.mark.asyncio
    async def test_multiple_files_workflow(self, mock_mcp_server, temp_workspace, mock_ha_api):
        """
