...
class TestValidateEntities:
    ...
    async def test_all_entities_exist(self):
        ...
        with aioresponses() as mock:
            mock.get(f"{url}/api/states", status=200, payload=mock_states)
    ...
    async def test_api_error_response(self):
        ...
        with aioresponses() as mock:
            mock.get(f"{url}/api/states", status=500, body="Internal Server Error")
    ...
    async def test_api_error_404(self):
        ...
        with aioresponses() as mock:
            mock.get(f"{url}/api/states", status=404, body="Not Found")
    ...
    async def test_malformed_api_response(self):
        ...
        with aioresponses() as mock:
            mock.get(f"{url}/api/states", status=200, body="This is not valid JSON")
    ...
    async def test_order_preservation(self):
        ...
        entity_ids = ["sensor.a", "sensor.b", "sensor.c", "sensor.d", "sensor.e"]
